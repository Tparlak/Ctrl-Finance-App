            ...
            sliver: SliverGrid(
              ...
              delegate: SliverChildListDelegate([
                _CtrlTile(
                  ...
                  title: 'GÜVENLİK',
                  subtitle: 'Parmak izi & yüz kilidi',
                  accent: AppColors.blue,
                  onTap: () => _showComingSoon(context, 'Biyometrik Kilit'),
                ),
                _CtrlTile(
                  icon: Icons.file_download_rounded,
                  title: 'DIŞA AKTAR',
                  subtitle: 'Excel / CSV olarak indir',
                  accent: AppColors.green,
                  onTap: () => _showComingSoon(context, 'Dışa Aktarma'),
                ),
                _CtrlTile(
                  icon: Icons.palette_rounded,
                  title: 'GÖRÜNÜM',
                  subtitle: 'Renk teması seç',
                  accent: AppColors.gold,
                  onTap: () => _showComingSoon(context, 'Tema Seçici'),
                ),
                _CtrlTile(
